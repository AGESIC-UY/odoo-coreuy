...
class account_move_line(osv.osv):
    ...
    _columns = {
        ...
        'bank_acc_rec_statement_id': fields.many2one('bank.acc.rec.statement', 'Bank Acc Rec Statement',
                                                     help="The Bank Acc Rec Statement linked with the journal item"),
        'draft_assigned_to_statement': fields.boolean('Assigned to Statement? ',
