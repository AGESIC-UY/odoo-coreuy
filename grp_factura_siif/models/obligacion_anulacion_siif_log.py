...
class obligacion_anulaciones_siif_log(osv.osv):
    _name = 'obligacion.anulacion.siif.log'
    _description = "Log obligacion anulaciones"

    _columns = {
        'invoice_id': fields.many2one('account.invoice', 'Obligacion OC', required=True,ondelete='cascade'),
...
obligacion_anulaciones_siif_log()