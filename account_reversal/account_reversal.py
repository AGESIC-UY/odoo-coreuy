...
class account_move(models.Model):
    ...
    def _move_reversal(self, reversal_date,
        ...
        # irabaza => Asegurar que no se valide el asiento pasando novalidate=True por context
        # cuando el diario tiene especificado asentar automáticamente
        reversal_move = self.with_context(novalidate=True).copy(default={
            'company_id': self.company_id.id,
            'date': reversal_date,
        ...
        reversal_move.with_context(novalidate=False).button_validate()
