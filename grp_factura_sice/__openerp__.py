...

{
    ...
    'images': [],
    'depends': ['grp_compras_estatales', 'grp_sice'],
    'description': """
...
""",
    'data': [
        'workflow/grp_pedido_compra_workflow.xml',
        'views/grp_factura_sice_view.xml',
        'views/grp_cotizaciones_view.xml',
        'views/grp_pedido_compra_view.xml',
        'views/purchase_order_view.xml',
        'wizard/grp_importar_adjudicacion_wizard_view.xml',
        'wizard/grp_importar_adjudicacion_cm_wizard_view.xml',
    ],
    'installable': True,
    'auto_install': False,
}
